            ...
            {allocMode==="manuel"&&(()=>{
              ...
              function exportManuelPDF() {
                ...
                const html = "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>Allocation Manuelle — Les Associés</title>"
                  ...
                  +"@media print{body{background:#fff}@page{size:A4 landscape;margin:10mm}.wrap{padding:0;max-width:100%}.card{box-shadow:none;page-break-inside:avoid}table{font-size:8px}th,td{padding:4px 3px!important}th:first-child,td:first-child{min-width:80px!important}}</style></head><body><div class='wrap'>"
